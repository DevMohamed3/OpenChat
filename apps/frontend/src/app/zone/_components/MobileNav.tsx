...
export function MobileNav({ user }: { user: any }) {
  ...
  return (
    <div className="md:hidden flex items-center h-12 px-4 border-b border-white/5 bg-background justify-between z-50">
      <Sheet open={open} onOpenChange={setOpen}>
        ...
        <SheetContent side="left" className="p-0 w-[320px] bg-background border-r-white/5 flex">
