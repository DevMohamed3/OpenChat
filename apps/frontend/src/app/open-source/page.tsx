    ...
    <div className="dark min-h-screen bg-background selection:bg-cyan-500/30">
      ...
      <main className="pt-32 pb-24">
        ...
        <div className="fixed inset-0 pointer-events-none -z-10 overflow-hidden">
           <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-cyan-500/5 blur-[160px] rounded-full" />
        </div>
        ...
        <section className="container mx-auto px-6 text-center mb-24 relative overflow-hidden">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-zinc-400 text-[10px] font-bold mb-10 uppercase tracking-[0.2em] backdrop-blur-md">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 tracking-tight leading-tight">
              Privacy as a <br />
              <span className="bg-gradient-to-r from-cyan-400 to-primary bg-clip-text text-transparent">Public Property.</span>
            </h1>
             ...
             {[
               ...
               },
               {
                ...
                <motion.div
                  ...
                  className="p-8 rounded-3xl border border-white/5 bg-white/[0.02] hover:border-white/10 transition-all group"
                >
                   <div className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-cyan-400 mb-6 group-hover:scale-110 transition-transform">
                      <pillar.icon size={20} />
                   </div>
                   <h4 className="text-lg font-bold text-white mb-3">{pillar.label}</h4>
        ...
        <section className="container mx-auto px-6 mb-32">
           <div className="max-w-4xl mx-auto rounded-3xl border border-white/5 bg-gradient-to-br from-cyan-500/10 via-background to-background p-8 md:p-16 relative overflow-hidden group">
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center gap-16">
                 <div className="flex-1">
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 text-[10px] font-bold mb-8 uppercase tracking-[0.2em]">
                 ...
                 <div className="w-full md:w-64 aspect-square rounded-3xl border border-white/10 bg-black/40 backdrop-blur-xl p-8 flex flex-col items-center justify-center shadow-2xl relative">
                    <Server size={64} className="text-cyan-400 mb-6 animate-pulse" />
                    <span className="text-[10px] text-zinc-500 font-mono uppercase">Node ready</span>
                    <div className="absolute -bottom-8 -left-8 w-24 h-24 bg-cyan-500/10 blur-[40px]" />
                 </div>
              </div>
           </div>
        </section>
